      ...
      return {
        ...
        keymaps = {
          ...
          diff3 = {
            ...
            { { "n", "x" }, "3do", actions.diffget("theirs"), { desc = "Obtain the diff hunk from THEIRS" } },
            { "n", "g?", actions.help({ "view", "diff3" }), { desc = "Open the help panel" } },
          },
          diff4 = {
            { { "n", "x" }, "1do", actions.diffget("base"), { desc = "Obtain the diff hunk from BASE" } },
            { { "n", "x" }, "2do", actions.diffget("ours"), { desc = "Obtain the diff hunk from OURS" } },
            { { "n", "x" }, "3do", actions.diffget("theirs"), { desc = "Obtain the diff hunk from THEIRS" } },
          ...
          file_history_panel = {
            ...
            { "n", "<C-A-d>", actions.open_in_diffview, { desc = "Open the entry in diffview" } },
            { "n", "y", actions.copy_hash, { desc = "Copy the commit hash" } },
            { "n", "L", actions.open_commit_log, { desc = "Show commit details" } },
            { "n", "X", actions.restore_entry, { desc = "Restore file to selected entry" } },
            { "n", "zo", actions.open_fold, { desc = "Expand fold" } },
            { "n", "zc", actions.close_fold, { desc = "Collapse fold" } },
            { "n", "h", actions.close_fold, { desc = "Collapse fold" } },
            { "n", "za", actions.toggle_fold, { desc = "Toggle fold" } },
